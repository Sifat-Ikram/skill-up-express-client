...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="navbar bg-accent w-full px-10">
        <div className="text-white navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu text-accent font-semibold rounded-xs menu-md dropdown-content bg-white mt-3 z-[1] p-2 shadow-xl w-52"
            >
              {navLinks}
            </ul>
          </div>
          <a className="block text-left cursor-pointer font-lato" href="/">
            <h1 className="text-4xl italic font-extrabold uppercase">skillup express</h1>
          </a>
        </div>
